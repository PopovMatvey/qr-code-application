...
// Данные контакта
export function ContactData({ title, decodedText, data, setData, IdItemCutawayApp, setDecodedText, dataListDepartaments, setDataListDepartaments, listUsersBitrix, idUserDefault, date, listContacts, listCompany, showCam, setShowCam }) {
    return (
        <>
            ...
            <DataContactContainer decodedText={decodedText} data={data} setData={setData} IdItemCutawayApp={IdItemCutawayApp} setDecodedText={setDecodedText} 
                ...
                date={date} listContacts={listContacts} listCompany={listCompany} />
        </>
    )
}