...
export function DataContactContainer({ decodedText, data, date, setData, IdItemCutawayApp, setDecodedText, dataListDepartaments, setDataListDepartaments, listUsersBitrix, idUserDefault }) {
    // /* Поля ввода */
        ...
        <>
            ...
            <div className="push">
                <form onSubmit={handlerSubmitDataContact}>
                    ...
                    <div className="data-contact-container_drop-down">
                        <DropdownHOC
                            idFull="0"
                            mode="hierarchical"
                    ...
                    <div className="data-contact-container_submit">
                        <table width="100%" className="tableInDataContainer" /*border = "1px" solid="1px"*/>
                            <tbody>
                                ...
                                {/* <tr>
                                    {(responsibleInput == "Никита Лактюшин") && <>
